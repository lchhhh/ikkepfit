            ...
            <div class="col-md-6 col-xl-4">
                <div class="card" style="width: 925px; margin: 30px 3px 10px 0px">
                    ...
                    <div class="card-header">
                            <p><asp:Label ID="lblkeys" runat="server" Text="用户注册"></asp:Label></p>
                    </div>
                    <div class="card-body">
                                ...
                                <p class="MsoNormal" style="margin-left: 6.0000pt; text-align: left; background: #FFFFFF;">
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" style="font-size: 12px;">
                                        <tr>
                                            ...
                                            <td class="tbright">
                                                <div style="display: inline; float: left;">
                                                    <asp:TextBox ID="txt_lname" runat="server" Width="200" class="form-control"></asp:TextBox>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tbright">
                                                <div style="display: inline; float: left;">
                                                    <asp:TextBox ID="txt_pass" runat="server" Width="200" TextMode="Password" class="form-control"></asp:TextBox>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tbright">
                                                <div style="display: inline; float: left;">
                                                    <asp:TextBox ID="txt_pass2" runat="server" Width="200" TextMode="Password" class="form-control"></asp:TextBox>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tbright">
                                                <div style="display: inline; float: left;">
                                                    <asp:TextBox ID="txt_mname" runat="server" Width="200" class="form-control"></asp:TextBox>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tbright">
                                                <div style="display: inline; float: left;">
                                                    <asp:TextBox ID="txt_tel" runat="server" Width="200" class="form-control"></asp:TextBox>
                                                </div>
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td>
                                                <asp:Button ID="btnSave" class="btn btn-primary" Width="150px" runat="server" Text="注  册" OnClick="btnSave_Click" OnClientClick="return jQuery.formValidator.PageIsValid('1');"></asp:Button>
                                            </td>
                                        </tr>
            ...
            <%--<div class="main_right">
                <div class="dqwz">
                    <div class="dqwz_title">
                        <p>您当前的位置：</p>
                        <span><a href="default.aspx">首页</a> &gt; <a href="#">用户注册</a></span></div>
                                ...
                                <p class="MsoNormal" style="margin-left: 6.0000pt; text-align: left; background: #FFFFFF;">
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" style="font-size: 12px;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tbright">
                                                <div style="display: inline; float: left;">
                                                    <asp:TextBox ID="txt_pass" runat="server" Width="200" TextMode="Password"></asp:TextBox>
                                                </div>
                                                <div id="ctl00_ContentPlaceHolder1_txt_passTip" style="width: 250px; display: inline; float: left; text-align: left;"></div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tbright">
                                                <div style="display: inline; float: left;">
                                                    <asp:TextBox ID="txt_pass2" runat="server" Width="200" TextMode="Password"></asp:TextBox>
                                                </div>
                                                <div id="ctl00_ContentPlaceHolder1_txt_pass2Tip" style="width: 250px; display: inline; float: left; text-align: left;"></div>
                                            </td>
                                        </tr>
