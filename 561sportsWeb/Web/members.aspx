<%@ Page Language="C#"  MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="members.aspx.cs" Inherits="members_Modify" ValidateRequest="false" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">个人中心</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
...
<asp:Image ID="Imagepic" runat="server"  Width="60px" Height="60px" /><asp:Label ID="Labelpic"  Visible="false" runat="server"  ></asp:Label><asp:FileUpload ID="fppic" runat="server" Width="250" />支持格式为：.jpg | .gif | .png
            ...
            <tr>
              <td >&nbsp;</td>
              <td >  
                  <asp:Button ID="btnSave" runat="server" Text="保  存" OnClick="btnSave_Click"  BackColor="#F4FBFF" CssClass="bt" OnClientClick="return jQuery.formValidator.PageIsValid('1');"></asp:Button>
              </td>
            </tr>
