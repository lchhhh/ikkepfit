<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="plans_Modify" ValidateRequest="false" Title="" %>
                ...
                <tr>
                    <td align="left">
                        <table>
                            <tr>
                                <td>
                                    <img src="../../images/main_home.gif" width="16" height="16" /></td>
                                <td>
                                    <label><span id="navTitle">健身计划管理---编辑健身计划</span></label></td>
                            </tr>
                        </table>
                    </td>
                    <td align="right">
                        <table>
                            <tr>
                                <td>
                                    <img src="../../images/arrow_left.png" width="16" height="16" /></td>
                                <td>
                                    <label><a href="List.aspx" class="sub_menu">返回</a></label></td>
                            </tr>
                        </table>
                    </td>
                </tr>
    ...
    <div class="frmstatic" style="display: block; margin-top: 10px;">
        ...
        <div class="controls">
            ...
            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#ecf5ff">
                ...
                <tr>
                    <td style="text-align: right; width: 20%;">所属类别:</td>
                    <td class="tbright">
                        <div style="display: inline; float: left;">
