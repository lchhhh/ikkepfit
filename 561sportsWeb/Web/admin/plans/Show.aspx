<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Show.aspx.cs" Inherits="plans_Detail" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">健身计划管理---查看健身计划</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
