<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="members_Manage" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">用户管理---用户列表</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
...
<div class="controls">
    ...
    <asp:Button ID="Button1" runat="server" Text="搜 索"   onclick="btnSearch_Click" />
        ...
        <Columns>       
            ...
            <asp:BoundField HeaderText="昵称" DataField="mname" />
