<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="pass.aspx.cs" ValidateRequest="false" Inherits="pass" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">系统管理---修改密码</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
