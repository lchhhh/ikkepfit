<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Show.aspx.cs" Inherits="article_Detail" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">帖子管理---查看帖子</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
...
<div class="controls">
 ...
 <tr>
	<td height="25" width="20%" align="right">浏览次数：</td>
	<td height="25" width="*" align="left" style="text-align:left"><asp:Label ID="lbltotal1" runat="server" Text=""></asp:Label></td>
	</tr>
 <tr>
	<td height="25" width="20%" align="right">发贴人：</td>
