<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="plansType_Manage" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">健身计划管理---健身计划类别列表</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
