<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" ValidateRequest="false" Inherits="plansType_Add" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">健身计划管理---添加健身计划类别</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
