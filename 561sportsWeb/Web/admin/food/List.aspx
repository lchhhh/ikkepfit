<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="food_Manage" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">食物库管理---食物列表</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
...
<div class="controls">
          ...
          <table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#ecf5ff">
           <tr>
            <td align="center">
            <strong> 食物名称:</strong><asp:TextBox ID="txt_title" runat="server" width="150"></asp:TextBox>
    ...
    <asp:Button ID="Button1" runat="server" Text="搜 索"   onclick="btnSearch_Click" />
        ...
        <Columns>       
            <asp:BoundField HeaderText="食物名称" DataField="title" />
            <asp:TemplateField HeaderText="食物图片">
            <ItemTemplate>
