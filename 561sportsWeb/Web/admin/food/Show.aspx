<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Show.aspx.cs" Inherits="food_Detail" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">食物库管理---查看食物</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
...
<div class="controls">
 ...
 <tr>
	<td height="25" width="20%" align="right">食物名称：</td>
