<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="food_Modify" ValidateRequest="false" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">食物库管理---编辑食物</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
...
<div class="controls">
          ...
          <table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#ecf5ff">
             <tr>
<td  style=" text-align:right; width:20%;">食物名称:</td>
...
<tr>
<td  style=" text-align:right; width:20%;">食物图片:</td>
<td class="tbright"><div style="display:inline;float:left;">
