<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="equip_Modify" ValidateRequest="false" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">健身装备管理---编辑健身装备</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
