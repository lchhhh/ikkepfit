<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="equip_Manage" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">运动装备管理---运动装备列表</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
