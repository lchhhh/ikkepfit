<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="action_Modify" ValidateRequest="false" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">动作库管理---编辑运动动作</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
...
<td class="tbright"><div style="display:inline;float:left;">
<asp:TextBox ID="txt_acal" runat="server" width="200"></asp:TextBox></div><div id="ctl00_ContentPlaceHolder1_txt_titleTip" style="width:250px;display:inline;float:left;text-align:left;"></div>
 </td></tr>
