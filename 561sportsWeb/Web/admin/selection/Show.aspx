<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Show.aspx.cs" Inherits="selection_Detail" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">装备选择管理---查看装备选择</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
