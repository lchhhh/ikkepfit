<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="selection_Manage" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">装备选择管理---装备选择列表</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
...
<div class="controls">
          ...
          <table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#ecf5ff">
           <tr>
            <td align="center">
            <strong> 装备选择标题:</strong><asp:TextBox ID="txt_title" runat="server" width="150"></asp:TextBox>
    ...
    <asp:Button ID="Button1" runat="server" Text="搜 索"   onclick="btnSearch_Click" />
        ...
        <Columns>       
            <asp:BoundField HeaderText="装备选择标题" DataField="title" />
