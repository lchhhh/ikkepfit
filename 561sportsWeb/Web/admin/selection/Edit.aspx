<%@ Page Language="C#" MasterPageFile="~/admin/site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="selection_Modify" ValidateRequest="false" Title="" %>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><label><span id="navTitle">装备选择管理---编辑装备选择</span></label></td>
                    </tr>
                </table>
            </td>
            <td align="right">
...
<div class="controls">
          ...
          <table width="100%"  border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#ecf5ff">
             <tr>
<td  style=" text-align:right; width:20%;">装备选择标题:</td>
...
<tr>
<td  style=" text-align:right; width:20%;">装备选择内容:</td>
<td class="tbright"><div style="display:inline;float:left;">
...
<script language="javascript" type="text/javascript">
    $(document).ready(function() {
        ...
        $("#ctl00_ContentPlaceHolder1_txt_title").formValidator({ onshow: "请输入装备选择标题", onfocus: "装备选择标题不能为空", oncorrect: "合法" }).InputValidator({ min: 1, onerror: "装备选择标题不能为空,请确认" });
    });
</script>
