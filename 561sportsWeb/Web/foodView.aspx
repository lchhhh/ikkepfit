<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="foodView.aspx.cs" Inherits="about" %>
                    ...
                    <div class="card" style="width: 925px; margin: 30px 3px 10px 0px">
                        ...
                        <div class="card-body">
                            <p class="MsoNormal" style="margin-left: 6.0000pt; text-align: left; background: #FFFFFF;">
                                <asp:Image ID="imgpic" runat="server" Width="60" Height="60" />
                            </p>
                            <p class="MsoNormal" style="margin-left: 6.0000pt; text-align: left; background: #FFFFFF;">
                                <asp:Literal ID="lblmemo" runat="server"></asp:Literal>
                            </p>
                            <p class="MsoNormal" style="margin-left: 6.0000pt; text-align: left; background: #FFFFFF;">
                                <asp:Literal ID="lblfcal" runat="server"></asp:Literal>
                            </p>
                        </div>
                    </div>
                </div>
