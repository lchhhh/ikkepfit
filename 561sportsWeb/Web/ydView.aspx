<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ydView.aspx.cs" Inherits="about" %>
	...
	<div id="wrap">
    	<div class="main">
            ...
            <div class="main_right">
            	<div class="dqwz">
                	<div class="dqwz_title"><p>您当前的位置：</p><span><a href="default.aspx">首页</a> &gt; <a href="#">运动装备详情</a></span></div>
...
&nbsp;&nbsp; 发布时间： 
                        ...
                        <div class="ncontent" style="text-indent:24px; line-height:29px;">
                            <table width="100%"><tr><td align="center">
                                <asp:Image ID="imgpic" runat="server" Width="320" Height="320" />
                                                    </td></tr></table>
