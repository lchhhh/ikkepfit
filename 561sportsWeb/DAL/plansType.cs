...
namespace SP.DAL
{
    ...
    public partial class plansType
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("tid", "plansType");
        }
        ...
        public bool Exists(int tid)
        {
            ...
            strSql.Append("select count(1) from plansType");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into plansType(");
            strSql.Append("tname)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update plansType set ");
        ...
        public bool Delete(int tid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from plansType ");
            strSql.Append(" where tid=@tid");
            SqlParameter[] parameters = {
					new SqlParameter("@tid", SqlDbType.Int,4)
			};
        ...
        public SP.Model.plansType GetModel(int tid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 tid,tname from plansType ");
            strSql.Append(" where tid=@tid");
            SqlParameter[] parameters = {
					new SqlParameter("@tid", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public SP.Model.plansType DataRowToModel(DataRow row)
        {
            SP.Model.plansType model = new SP.Model.plansType();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from plansType T ");
