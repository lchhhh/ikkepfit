...
namespace SP.DAL
{
	...
	public partial class equip
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "equip"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from equip");
		...
		public SP.Model.equip GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,title,pic,memo,atime from equip ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SP.Model.equip DataRowToModel(DataRow row)
		{
			SP.Model.equip model=new SP.Model.equip();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from equip T ");
